...
require('lazy').setup({
  -- apoulos
  -- failed experiment with https://github.com/nat-418/tcl.nvim
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      -- apoulos made <leader>/ toggle comment
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      --   local disable_filetypes = { c = true, cpp = true, jsonc = true, java = true, bash = true }
      --   return {
      --     timeout_ms = 500,
    ...
    config = function()
      ...
      cmp.setup {
        ...
        mapping = cmp.mapping.preset.insert {
          -- apoulos useful when auto_open = false in view above
